            ...
            <form method="POST" action="/users/mypage">
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="name" class="text-md-left mershige-edit-user-info-label">氏名</label>
                    ...
                    <div class="collapse show userName">
                        <h1 class="mershige-edit-user-info-value">{{ $user->name }}</h1>
                    </div>
                    <div class="collapse editUserName">
                        ...
                        <button type="submit" class="btn mershige-submit-button mt-3 w-25">
                            保存
                        </button>
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="email" class="text-md-left mershige-edit-user-info-label">メールアドレス</label>
                    ...
                    <div class="collapse show userMail">
                        <h1 class="mershige-edit-user-info-value">{{ $user->email }}</h1>
                    </div>
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="phone" class="text-md-left mershige-edit-user-info-label">電話番号</label>
